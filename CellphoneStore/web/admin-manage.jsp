                ...
                <div class="col-12 content">
                    ...
                    <div class="second-nav">
                        ...
                        <select name="" id="sort">
                            ...
                            <option value="">Giá tăng lên</option>
                        ...
                        <tbody>
                            <c:forEach items="${plist}" var="p">
                                <tr>
                                    ...
                                    <td>${p.price}</td>
                                    <td>${p.amount}</td>
                                    <td><a href="<c:url value="/admin-update?pid=${p.pid}"/>">Xem chi tiết</a>&nbsp;|&nbsp;<a href="#" onclick="openModal('${p.pid}')">Xóa</a></td>
                                </tr>
                            </c:forEach>
                    ...
                    <div class="paging-wrapper">
                        <ul class="paging">
                            ...
                            <li class="paging-items"><a href="">1</a></li>
                            <li class="paging-items"><a href="">2</a></li>
                            <li class="paging-items"><a href="">3</a></li>
